		...
		<>
			...
			{!CallState.videoCall?.outgoing &&
				...
				!CallState.voiceCall?.incoming && (
					<div className="relative z-0 flex h-screen max-h-screen w-screen max-w-full flex-col items-center justify-center overflow-hidden bg-[#d1d7db] dark:bg-[#111b21]">
						{loading || !session ? (
							...
							<>
								<div className="absolute left-0 top-0 -z-10 h-[222px] w-full bg-[#00a884] dark:bg-[#111b21]" />
								
								<div className="flex h-full w-full max-w-[1600px] overflow-hidden bg-white shadow-[0_17px_50px_0_rgba(11,20,26,.19),_0_12px_15px_0_rgba(11,20,26,.24)] dark:bg-[#222e35] md:h-[calc(100vh-40px)] md:w-[calc(100vw-40px)] md:rounded-lg">
									<div className="grid h-full w-full grid-cols-1 lg:grid-cols-main">
										<ChatList />
										{conversationId ? (
											<div className={MessageSearch ? "grid grid-cols-1 lg:grid-cols-2" : "grid-cols-1 lg:grid-cols-1"}>
